...
# execute as @a if score @s player_die matches 1.. at @s run function evola_dp:death_essence
# execute as @a unless score @s player_id = @s player_id run function evola_dp:init_player_id